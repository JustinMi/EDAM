var clean_data = {}; //final data to log to console

// dowloading API data based on search query
$.ajax("https://search.idigbio.org/v2/search/records/", 
{
    dataType: 'json',
    contentType: 'application/json',
    type: "POST",
    data: JSON.stringify({limit:50000, rq:{scientificname:"puma concolor"}})
}).done(function(data) {
  console.log(data);
...
// add cleaned results to object
  ...
  clean_data['general data'] = aggregate_gen_data;
